...
function Dashboard() {
    ...
    const handleDeclareDateClick = () => {
      router.push('/admin/declare-date')
    }
  ...
  return (
    <div className="flex flex-row h-full lg:h-screen">
      <AdminMenu/>
      <div className="flex-grow bg-gray-100 p-4">
        ...
        <Card key={index} {...candidate} btn1="Accept" btn2="Reject"/>
      ))}
        </div>
      </div>
    </div>
